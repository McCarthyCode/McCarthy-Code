...
$(function(){function a(){var a=$(this).width(),c=$(".navbar-brand"),f=$("#navbarCollapse");992>a?f.hide():f.css("display","inline");a<b.min?c.hide():a<b.full?c.css("display","inline").attr("data-content","M. C."):c.css("display","inline").attr("data-content","McCarthy Code")}$("a.external-link").after(' <i class="fas fa-external-link-alt" title="External Link"></i>');var b={min:308,full:403},c=function(){var a=$("<div>").css({visibility:"hidden",width:100,overflow:"scroll"}).appendTo("body"),b=$("<div>").css({width:"100%"}).appendTo(a).outerWidth();
a.remove();return 100-b}();Object.keys(b).forEach(function(a){b[a]+=c});$("#navbarMenuButton").on("click",function(){$("#navbarCollapse").slideToggle()});$(window).on("resize orientationchange",a);a();$("textarea").each(function(){var a=$(this),b=a.val().length,c=a.attr("maxlength");if(a.is(":visible")){var g=$("<div>");b=$("<small>").html(b+"/"+c);a.after(g.append(b))}});$("textarea").on("input",function(){var a=$(this),b=a.next("div").children("small"),c=a.val().length;a=a.attr("maxlength");b.html(c+
"/"+a)})});

...
$(document).ready(function(){var a=$("#navbar").outerHeight();$(".contents a").click(function(b){b.preventDefault();history.pushState({},"",this.href);$("html, body").animate({scrollTop:$("#"+$(this).data("slug")).offset().top-a},1E3)});$("#portfolio > header:not(:last-child), #portfolio > section:not(:last-child)").each(function(){var b=$(this),c=b.next();c.height(Math.ceil(c.height()));b.find(".chevron").click(function(){$("html, body").animate({scrollTop:c.offset().top-a},1E3)})});$(window).on("resize orientationchange",
function(){$("#portfolio > header, #portfolio > section").each(function(){$(this).css({height:""})})})});

...
$(document).ready(function(){var a=[].concat($jscomp.arrayFromIterable(Array(5).keys()));a.splice(0,1);var b=$("#navbar").outerHeight();a.forEach(function(a){$("section:nth-child("+a+") .chevron i").click(function(){$("html, body").animate({scrollTop:$("section:nth-child("+(a+1)+")").offset().top-b},1E3)})})});

...
$jscomp.defineProperty(e,d,{configurable:!0,writable:!0,value:c})))};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,b){return $jscomp.findInternal(this,a,b).v}},"es6","es3");$(document).ready(function(){var a=$("#navbar").outerHeight();$("#portfolio > section:not(:last-of-type)").each(function(){var c=$(this).next();$(this).find(".chevron").click(function(){$("html, body").animate({scrollTop:c.offset().top-a},1E3)})})});
